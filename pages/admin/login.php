                        ...
                        <div class="px-2 pt-3">
                            <form action="cek_login.php" method="POST">
                                <div class="my-2">
                                    ...
                                    <input class="form-control form-control-lg" type="text" name="username" id="username" placeholder="Masukkan Username">
                                </div>
                                <div class="mt-3">
                                    <div class="mb-2">
                                ...
                                <?php
                                    if (isset($_GET['error'])) {
                                        if ($_GET['error'] == 1) {
                                            echo "<div class=\"mt-3\"><p>Username atau password salah!</p></div>";
                                        }
                                    }
                                ?>

...
<body>
    ...
    <div class="container menu-section">
        <h1>MENU MEAT</h1>
        <div class="menu-item">
            <img src="../../resource/images/Grilled chicken skeweer.jpg" alt="Grilled Chicken Skewer">
            <h2>Grilled Chicken Skewer</h2>
            <p>Sate ayam yang dipanggang sempurna dengan cita rasa yang lezat. Potongan daging ayam yang juicy dan beraroma.</p>
            <h5>Rp.30.000</h5>
        </div>
        <div class="menu-item">
            <img src="../../resource/images/Wagyo saikoro skeweer.jpg" alt="Wagyu Saikoro Skewer">
            <h2>Wagyu Saikoro Skewer</h2>
            <p>Sate daging wagyu yang berkualitas. Daging yang juicy dan empuk disajikan dengan saus istimewa dan sayuran segar.</p>
            <h5>Rp.44.000</h5>
        </div>
    </div>

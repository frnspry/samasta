...
<html lang="en">
    ...
    <body>
        ...
        <div class="container menu-section">
            <h1>MENU SNACK</h1>
            <div class="menu-item">
                <img src="../../resource/images/Pisang goreng keju.jpg" alt="Pisang Goreng Keju">
                <h2>Pisang Goreng Keju</h2>
                <p>Gorengan pisang yang manis dan renyah disajikan dengan sentuhan keju yang gurih.</p>
                <h5>Rp.22.000</h5>
            </div>
            <div class="menu-item">
                <img src="../../resource/images/French fries.jpg" alt="French Fries">
                <h2>French Fries</h2>
                <p>Kentang yang dipotong memanjang dan digoreng hingga keemasan, menciptakan kerenyahan di luar dan lembut di dalam.</p>
                <h5>Rp.30.000</h5>
            </div>
            <div class="menu-item">
                <img src="../../resource/images/Beef burger.jpg" alt="Beef Burger">
                <h2>Beef Burger</h2>
                <p>Hidangan klasik daging sapi panggang diatas roti burger yang empuk, dilengkapi dengan sayuran dan keju yang creamy.</p>
                <h5>Rp.33.000</h5>
            </div>
            <div class="menu-item">
                <img src="../../resource/images/Chicken burger.jpg" alt="Chicken Burger">
                <h2>Chicken Burger</h2>
                <p>Alternatif yang lezat daging dada ayam yang juicy diatas roti burger yang empuk, dilengkapi dengan sayuran dan keju yang creamy.</p>
                <h5>Rp.33.000</h5>
            </div>
        </div>

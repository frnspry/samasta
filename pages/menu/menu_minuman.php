...
<body>
    ...
    <div class="container menu-section">
        <h1>MENU MINUMAN</h1>
        <div class="menu-item">
            <img src="../../resource/images/Special Lechy.jpg" alt="Special Lychee">
            <h2>Special Lychee</h2>
            <p>Minuman segar yang memanjakan dengan rasa manis khas leci. Disajikan dingin dengan potongan buah leci segar asli.</p>
            <h5>Rp.40.000</h5>
        </div>
        <div class="menu-item">
            <img src="../../resource/images/Fantastic Mango.jpg" alt="Fantastic Mango">
            <h2>Fantastic Mango</h2>
            <p>Minuman segar yang memikat dengan rasa manis mangga. Disajikan dingin dengan potongan buah mangga segar.</p>
            <h5>Rp.40.000</h5>
        </div>
        <div class="menu-item">
            <img src="../../resource/images/Ice Capuccino.jpg" alt="Cappuccino Ice">
            <h2>Cappuccino Ice</h2>
            <p>Minuman kopi yang menyegarkan. Disajikan dingin dengan taburan bubuk cokelat diatasnya.</p>
            <h5>Rp.20.000</h5>
        </div>
        <div class="menu-item">
            <img src="../../resource/images/Ice Thai tea.jpg" alt="Thai Tea Ice">
            <h2>Thai Tea Ice</h2>
            <p>Minuman khas Thailand yang menyegarkan dengan rasa teh yang creamy dan disajikan dingin agar kesegarannya terasa.</p>
            <h5>Rp.20.000</h5>
        </div>
        <div class="menu-item">
            <img src="../../resource/images/Ice Chocolate.jpg" alt="Chocolate Ice">
            <h2>Chocolate Ice</h2>
            <p>Minuman cokelat manis yang menyegarkan. Cokelat yang dicampur dengan susu dan disajikan dingin</br>dengan topping whipped cream serta taburan cokelat diatasnya.</p>
            <h5>Rp.20.000</h5>
        </div>
    </div>
